# InfraTales | Quantum Computing – Hybrid Quantum-Classical on AWS Braket

**Production-ready reference architecture for quantum computing with VQE and QAOA algorithms.**
